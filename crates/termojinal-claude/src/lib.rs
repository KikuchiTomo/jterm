//! Allow Flow engine for AI agent coordination in termojinal.
//!
...
/// entry point that the termojinal UI layer interacts with.
...
mod tests {
    ...
    fn test_process_no_detection() {
        let (mut engine, _tmp) = test_engine();
        let lines = &["Building project...", "Compiling termojinal v0.1.0"];
