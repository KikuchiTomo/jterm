//! Utility to sign termojinal commands.
//!
//! Usage:
//!   termojinal-sign <command.toml> <signing-key-hex>
...
use termojinal_ipc::command_signer;
...
fn main() {
    ...
    if args.len() != 3 {
        eprintln!("Usage: termojinal-sign <command.toml> <signing-key-hex>");
        eprintln!("       termojinal-sign --generate-key");
        std::process::exit(1);
    }
